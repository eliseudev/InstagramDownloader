...
const InstagramForm = () => {
  ...
  async function fetchVideo() {
    if (!postUrl) {
      return setErrorMsg("Cole a URL do Instagram para fazer o download.");
    }

    if (!postUrl.includes("instagram.com/")) {
      return setErrorMsg("Erro: a URL não contém o dominio do Instagram");
    }

    if (!postUrl.startsWith("https://")) {
      return setErrorMsg(
        'URL Invávlida Exemplo: "https://www.instagram.com..."'
      );
    }
    ...
    if (!postRegex.test(postUrl) && !reelRegex.test(postUrl)) {
      return setErrorMsg("O URL não corresponde à postagem ou reels do Instagram");
    }
    ...
    try {
      ...
      console.error(error);
      return setErrorMsg("Algo deu errado...");
    }
  }
    ...
    <>
      ...
      >
        <input
          ...
          title="Instagram video download URL"
        ...
        {loading ? (
          <button
            ...
            title="Carregando o video/reels do instagram para download"
            type="button"
